...
export const ui = {
  fr: {
    ...
    theme: 'Changer de thème', lang: 'English', discover: 'Découvrir',
    android: 'Télécharger Android', iphone: 'Télécharger iPhone',
  ...
  en: {
    ...
    theme: 'Change theme', lang: 'Français', discover: 'Explore',
    android: 'Download for Android', iphone: 'Download for iPhone',
...
export const pages: Record<Lang, Record<Slug, Page>> = {
  fr: {
    ...
    support: { title:'Nous sommes là pour vous aider', eyebrow:'Support', description:'Support officiel VueConfort : aide, diagnostic des problèmes courants et contacts dédiés.', intro:'Consultez d’abord les solutions rapides, puis écrivez-nous avec le modèle du téléphone et la version Android ou iOS.', sections:[
      ...
      {title:'Contacts',body:'Assistance : support@vueconfort.fr · Confidentialité : privacy@vueconfort.fr · Demandes générales : contact@vueconfort.fr'}
    ]},
    telechargement: { title:'VueConfort sur votre téléphone', eyebrow:'Téléchargement', description:'Télécharger VueConfort pour Android et iPhone depuis les boutiques officielles dès sa publication.', intro:'Les versions officielles seront distribuées exclusivement par Google Play et l’App Store. Cette page sera leur point d’accès permanent.', sections:[
      {title:'Android · Google Play',body:'La version Android comprend le grossissement système, la barre flottante, le lecteur accessible, les profils et les tests visuels. Publication en préparation.'},
      {title:'iPhone · App Store',body:'La version iPhone respectera les capacités et protections d’iOS. Publication en préparation.'},
    ...
    'a-propos': { title:'La technologie au service du confort', eyebrow:'À propos', description:'Découvrez la mission et les principes de VueConfort.', intro:'VueConfort part d’une idée simple : un écran peut mieux respecter les préférences de lecture de chacun.', sections:[
...
pages.en = {
  ...
  support:{title:'We are here to help',eyebrow:'Support',description:'Official VueConfort support, common issue guidance and dedicated contacts.',intro:'Check these quick solutions first, then write with your phone model and Android or iOS version.',sections:[{title:'The Android bar does not appear',body:'Check that VueConfort is enabled in Settings > Accessibility and that Samsung battery settings do not put it into deep sleep.'},{title:'Magnification does not change',body:'Reset magnification, then re-enable the service. Android may limit the controller while another service uses it.'},{title:'Read finds no text',body:'The current app probably exposes no accessibility content. VueConfort does not capture the screen as a substitute.'},{title:'Contacts',body:'Support: support@vueconfort.fr · Privacy: privacy@vueconfort.fr · General: contact@vueconfort.fr'}]},
  telechargement:{title:'VueConfort on your phone',eyebrow:'Download',description:'Download VueConfort for Android and iPhone from official stores when released.',intro:'Official versions will be distributed exclusively through Google Play and the App Store. This page will remain their permanent access point.',sections:[{title:'Android · Google Play',body:'The Android version includes system magnification, floating controls, accessible reader, profiles and visual tests. Release is in preparation.'},{title:'iPhone · App Store',body:'The iPhone version will respect iOS capabilities and protections. Release is in preparation.'},{title:'Safe installation',body:'Do not install APKs or profiles from third-party sites. Always verify the official VueConfort publisher and domain.'}]},
...
export const home = {
  fr: { title:'VueConfort', subtitle:'Votre écran s’adapte à vos yeux, pas l’inverse.', description:'VueConfort améliore le confort de lecture sur mobile grâce aux profils, au lecteur adapté et aux tests visuels sur écran.', intro:'Des outils visuels utiles, privés et compréhensibles pour lire plus confortablement sur votre téléphone.' },
  en: { title:'VueConfort', subtitle:'Your screen adapts to your eyes, not the other way around.', description:'VueConfort improves mobile reading comfort with profiles, an adapted reader and on-screen visual tests.', intro:'Useful, private and understandable visual tools for more comfortable reading on your phone.' }
};
