...
export const pages: Record<Lang, Record<Slug, Page>> = {
  fr: {
    android: { title:'VueConfort pour Android', eyebrow:'Bêta Android', description:'Découvrez VueConfort pour Android, actuellement en test fermé Google Play auprès de testeurs autorisés.', intro:'Version 1.0.1 actuellement en test fermé Google Play.', sections:[] },
    ...
    telechargement: { title:'VueConfort sur votre téléphone', eyebrow:'Téléchargement', description:'Disponibilité de VueConfort pour Android et état du développement de l’application iPhone.', intro:'Les versions officielles seront distribuées par Google Play et l’App Store lorsqu’elles seront prêtes. Aucun téléchargement direct non vérifié n’est proposé.', sections:[
      {title:'Android · test fermé',body:'Version 1.0.1 actuellement diffusée sur une piste de test fermé Google Play auprès de testeurs autorisés. Elle n’est pas disponible publiquement. Découvrez la page Android pour connaître les fonctions, la compatibilité et les limites.'},
...
pages.en = {
  android:{title:'VueConfort for Android',eyebrow:'Android beta',description:'Explore VueConfort for Android, currently available only to authorized testers through a closed Google Play test.',intro:'Version 1.0.1 is currently in closed testing on Google Play.',sections:[]},
...
export const androidBeta = {
  fr: {
    status:'Version 1.0.1 en test fermé Google Play', badge:'Test fermé Android',
    facts:[['Version','1.0.1'],['Plateforme','Android'],['Statut','Test fermé'],['Traitement','Local'],['Compte','Non requis'],['Publicité','Absente'],['Analytics','Absents']],
    features:[
  ...
  en: {
    status:'Version 1.0.1 in closed Google Play testing', badge:'Android closed test',
    facts:[['Version','1.0.1'],['Platform','Android'],['Status','Closed test'],['Processing','On-device'],['Account','Not required'],['Advertising','None'],['Analytics','None']],
    features:[
