...
Révision du 25 septembre 2026. Cette branche prépare l’incrément Native Vision ; elle ne constitue ni une publication ni une approbation Google Play. Les statuts de pistes de la console n’ont pas été déduits de documents historiques.

## Binaire et expérience à évaluer

- Release : `fr.vueconfort.app`, version de travail `1.0.2`, code 3 ; référence dans `gradle.properties`.
...
1. Reporter compilation, tests, recette commerciale sans privilège et restauration dans le rapport de l’incrément ; distinguer les tests ignorés. La recette Lab ne remplace pas une recette client.
...
5. Finaliser les traductions de Mon affichage et aligner textes FR/EN, images et limites avec le binaire. Les nouvelles chaînes ne constituent pas encore une couverture anglaise complète.
